#!/usr/bin/env python3
"""Apply the smoke-test preprocessing correction, then execute full_pipeline.py."""
...
assert old in s
s = s.replace(old, new)
compiled = compile(s, str(p), "exec")
globals_dict = {"__name__": "__main__", "__file__": str(p), "__package__": None}
