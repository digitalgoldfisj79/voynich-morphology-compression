#!/usr/bin/env python3
# Plumbing-only schema probe; retained for audit. Frozen V05 source/protocol live in split compressed payloads.
# Retrigger marker: exact split-source transport; scientific protocol and source bytes unchanged.
